...
// in simulator we redefine to format for iCoach Developer console
...
{\
	NSString * exceptionName = [@"org.icoach." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.icoach";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIiCoachNativeItemNone = -1, 
	UIiCoachNativeItemSpinner = -2,
	UIiCoachNativeItemProgressBar = -3,
	
	UIiCoachNativeItemSlider = -4,
	UIiCoachNativeItemSwitch = -5,
	UIiCoachNativeItemMultiButton = -6,
	UIiCoachNativeItemSegmented = -7,
	
	UIiCoachNativeItemTextView = -8,
	UIiCoachNativeItemTextField = -9,
	UIiCoachNativeItemSearchBar = -10,
	
	UIiCoachNativeItemPicker = -11,
	UIiCoachNativeItemDatePicker = -12,
	
	UIiCoachNativeItemInfoLight = -13,
	UIiCoachNativeItemInfoDark = -14,
	
	UIiCoachNativeItemDisclosure = -15,
	
	UIiCoachNativeItemContactAdd = -16
};
